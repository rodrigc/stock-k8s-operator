...
import (
	...
	"github.com/rodrigc/stock-k8s-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7d60330f.stock-operator.crodrigues.org",
	...
	if err = (&controller.StockQuoteReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "StockQuote")
		os.Exit(1)
	}
